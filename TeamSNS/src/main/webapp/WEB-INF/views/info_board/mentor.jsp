...
<body>
    <div id="div_info_list_main">
        ...
        <br>
        <div id="category">
            <input type="button" class="category btn btn-default" value="창업교육" onclick="location.href='edu'" />
            <input type="button" class="category btn btn-info" value="멘토링" onclick="location.href='mentor'" />
            <input type="button" class="category btn btn-default" value="행사" onclick="location.href='event'" /> </div>
        <table>
            <tr>
                <th>글번호</th>
                <th>글제목</th>
            ...
            <tr>
                ...
                <td id="info_title" name="info_title"><a href="http://www.k-startup.go.kr/common/announcement/announcementDetail.do?_searchTargetAgeCodeAll=on&searchDtlAncmSn=0&searchAppAtBinet=&searchTargetAgeCodeAll=A&searchPrefixCode=BOARD_701_001&_searchTargetComAgeCodeAll=on&searchTargetTypeCodeAll=A&searchAncmId=&searchType=&_searchAreaCodeAll=on&searchSortOrder=DATE&_searchTargetTypeCodeAll=on&pageIndex=1&searchKeyword=&searchTargetComAgeCodeAll=A&searchAreaCodeAll=A&searchAppAt=A&_searchTargetComAgeCode=onononononon&CSRF_NONCE=siEW4BB6hDOUOiglFh4/R5EZ&searchPostSn=77213&searchDetailAt=A&_searchTargetTypeCode=ononononononon&bid=701&_searchAreaCode=onononononononononononononononononon&mid=30256&searchSupportBizTypeCodeAll=N&_searchTargetAgeCode=ononon&searchBusinessSn=0">멘토링데이 참가자 모집공고</a></td>
                <td id="info_category" name="info_category"> 멘토링 </td>
                <td id="info_id" name="info_id">서울창조경제혁신센터ㅇㅇ</td>
                <td id="info_end" name="info_end">20161211</td>
            </tr>
        </table>
        <br>
