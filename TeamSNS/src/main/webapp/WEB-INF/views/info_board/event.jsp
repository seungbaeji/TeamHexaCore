...
<body>
    <div id="div_info_list_main">
        ...
        <div id="category">
            ...
            <input type="button" class="category btn btn-default" value="멘토링" onclick="location.href='mentor'" />
            <input type="button" class="category btn btn-info" value="행사" onclick="location.href='event'" /> </div>
        <table>
            <tr>
                <th>글번호</th>
                <th>글제목</th>
